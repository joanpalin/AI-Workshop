...
3. **[`02_session_2_building_ai_assistants/`](./02_session_2_building_ai_assistants/)** — Your first hands-on lab: a local AI assistant in LM Studio, connected to live web search and your own files. The `lab_guide.md` is your main companion here.
4. **[`03_session_3_building_agentic_ai/`](./03_session_3_building_agentic_ai/)** — From assistant to agent. You'll configure AnythingLLM Desktop with a Groq cloud model, run the ARK Industries IT Policy Intelligence Agent, and design a use case of your own.
