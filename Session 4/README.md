...
2. **Attack your own assistant** — paste three pre-written prompt injection attempts into your LM Studio ARK Industries assistant from Session 2 and observe what happens when there is no governance layer
