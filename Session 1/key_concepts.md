...
**Important distinction:** Agentic AI is the subject of Session 3. The shift from Session 2 to Session 3 involves moving to a larger, more capable cloud model (Groq's Llama 3.3 70B) — because reliable multi-step autonomous workflows require greater reasoning capability than the compact local model used in Session 2.
