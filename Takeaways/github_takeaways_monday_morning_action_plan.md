...
Upload one of your organisation's internal IT or security policies into AnythingLLM as a document. Then use the IT Policy Intelligence Agent — the same agentic workflow you ran in Session 3 — to ask it: "Search the web for the latest NCSC guidance on [your policy topic] and compare it to this document. What is covered? What is missing? What has changed in the last 12 months?" Review the output critically before acting on anything it surfaces.

**Tool:** AnythingLLM Desktop + Groq llama-3.3-70b + Tavily web search (your personal free-tier keys replace the shared workshop keys — see Q2 in the Session 3 Q&A)
...
**Time investment:** 45 minutes, including setting up your personal Groq and Tavily accounts and running the agent once or twice with different prompts.
...
**Tool:** LM Studio + Qwen 2.5 3B (your Session 2 setup, with a new system prompt)
...
**Tool:** Your completed Agent Design Canvas (printed) + AnythingLLM as a prototype environment
...
**Time investment:** 1.5 hours, including reviewing the canvas, writing the brief, and running a prototype version of the agent in AnythingLLM to validate that the task is achievable.
...
None of these require budget approval. None require your IT department's involvement at this stage. None require writing a line of code. All five use the exact tools you set up today — the only prerequisite is that your laptop is open and LM Studio or AnythingLLM is running.
...
*Cisco AI Technical Workshop — London, 16 June 2026*
*Tools used: LM Studio (lmstudio.ai) · AnythingLLM (anythingllm.com) · Groq (console.groq.com) · Tavily (app.tavily.com)*
